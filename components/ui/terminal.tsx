...
export const AnimatedSpan = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "grid text-xs font-normal tracking-tight text-wrap md:text-sm",
        className
      )}
      onAnimationComplete={() => {
        if (!sequence) return
...
export const TypingAnimation = ({
  ...
  return (
    <MotionComponent
      ref={elementRef}
      className={cn(
        "text-xs font-normal tracking-tight text-wrap text-white md:text-sm",
        className
      )}
      {...props}
    >
...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "z-0 h-full w-full rounded-xl border border-border bg-[#1b1b1b] dark:bg-[#0a0a0a]",
        className
      )}
    >
