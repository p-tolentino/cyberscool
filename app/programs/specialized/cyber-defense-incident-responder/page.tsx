...
export async function generateMetadata() {
  const program = programs.find(
    (p) => p.slug === "cyber-defense-incident-responder"
  )
  return {
...
export default function CyberDefenseIncidentResponderPage() {
  const program = programs.find(
    (p) => p.slug === "cyber-defense-incident-responder"
  )
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <AlertTriangle className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-purple/5 p-6">
              <p className="text-muted-foreground">
                ...
                virtual environment. This is a <strong>128-hour</strong>{" "}
          ...
          {/* Prerequisite Note */}
          <div className="mb-12 rounded-lg border bg-muted/50 p-4">
            <p className="text-sm text-muted-foreground">
              <strong>Prerequisite:</strong> Successful completion of SOC
              Analyst Level 1 is required to enroll in this advanced program.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            ...
            <p className="mb-6 text-muted-foreground">
              Registration conditional upon successful graduation of SOC Analyst
              Level 1.
            </p>
