...
import { CheckCircle2, Clock, User, Briefcase, Search } from "lucide-react"
...
export async function generateMetadata({
  ...
  const program = programs.find((p) => p.slug === "osint-analyst")
  return {
...
export default function OSINTAnalystPage({
  params,
}: {
  params: { slug: string }
}) {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <Search className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="mb-12">
            <h2 className="mb-6 flex items-center gap-2 text-2xl font-bold text-brand-purple">
              <Search className="size-6 text-brand-teal" />
              Program Goals
            </h2>
            <div className="rounded-lg border bg-brand-purple/5 p-6">
              <p className="text-muted-foreground">
                Provide analysts and investigators with a comprehensive skillset
                and practical tools to conduct modern investigations. Learn from
                expert instructors with vast experience in data collection and
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">
              Master OSINT Investigations
            </h3>
            <p className="mb-6 text-muted-foreground">
              Comprehensive OSINT training for crime analysts, fraud
              investigators, law enforcement, and intelligence professionals.
            </p>
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-teal/5 p-6">
              <p className="text-muted-foreground">
                ...
                . Technical skills and relevant tools are learned through
                practical hands-on and simulation exercises in a safe and secure
                virtual environment. This is a <strong>200-hours</strong>{" "}
