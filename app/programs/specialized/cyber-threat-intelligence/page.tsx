...
import { CheckCircle2, Clock, User, Briefcase, Eye } from "lucide-react"
...
export async function generateMetadata({
  ...
  const program = programs.find((p) => p.slug === "cyber-threat-intelligence")
  return {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <Eye className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="mb-12">
            <h2 className="mb-6 flex items-center gap-2 text-2xl font-bold text-brand-purple">
              <Eye className="size-6 text-brand-teal" />
              Program Goals
            </h2>
            <div className="rounded-lg border bg-brand-purple/5 p-6">
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Equip participants with theory and practical insights for
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="mt-0.5 size-4 flex-shrink-0 text-brand-teal" />
                  <span>
                    Empower use of open-source and cyber threat intelligence
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="mt-0.5 size-4 flex-shrink-0 text-brand-teal" />
                  <span>
                    Learn to investigate practically with low-technical
                    threshold skills and tooling
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-purple/5 p-6">
              <p className="text-muted-foreground">
                ...
                virtual environment. This is a <strong>160-hour</strong>{" "}
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            ...
            <p className="mb-6 text-muted-foreground">
              Gain essential skills in cyber threat intelligence, operational
              security, and open-source investigation tools.
            </p>
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-teal/5 p-6">
              <p className="text-muted-foreground">
                ...
                . Technical skills and relevant tools are learned through
                practical hands-on and simulation exercises in a safe and secure
                virtual environment. This is a <strong>160-hours</strong>{" "}
                training course delivered on a blended in-class and on-line
                platforms.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-brand-teal/5 p-8 text-center">
            ...
            <p className="mb-6 text-muted-foreground">
              Gain essential skills in cyber threat intelligence and open-source
              investigation tools.
            </p>
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Button
