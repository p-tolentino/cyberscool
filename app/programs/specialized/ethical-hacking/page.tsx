...
import { CheckCircle2, Clock, User, Briefcase, Terminal } from "lucide-react"
import { programs } from "@/lib/data/programs"

export async function generateMetadata() {
  const program = programs.find((p) => p.slug === "ethical-hacking")
  return {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <Terminal className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">Master Ethical Hacking</h3>
            <p className="mb-6 text-muted-foreground">
              Become a certified ethical hacker and penetration tester with
          ...
          <div className="rounded-2xl bg-brand-teal/5 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">Master Ethical Hacking</h3>
            <p className="mb-6 text-muted-foreground">
              Learn to think like a hacker to better defend systems.
              OSCP-aligned curriculum.
            </p>
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Button
