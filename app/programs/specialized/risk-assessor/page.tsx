...
export async function generateMetadata() {
  const program = programs.find((p) => p.slug === "risk-assessor")
  return {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <ClipboardCheck className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">Master Risk Assessment</h3>
            <p className="mb-6 text-muted-foreground">
              Equip yourself with the skills to identify, assess, and mitigate
              cybersecurity risks.
            </p>
          ...
          <div className="rounded-2xl bg-brand-teal/5 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">Mitigate Cyber Risks</h3>
            <p className="mb-6 text-muted-foreground">
              Learn to identify, assess, and mitigate organizational cyber risks
