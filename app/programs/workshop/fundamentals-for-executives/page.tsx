...
import { CheckCircle2, Clock, User, Briefcase, Building2 } from "lucide-react"
import { programs } from "@/lib/data/programs"

export async function generateMetadata() {
  const program = programs.find((p) => p.slug === "fundamentals-for-executives")
  return {
...
export default function FundamentalsForExecutivesPage({
  params,
}: {
  params: { slug: string }
}) {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <Building2 className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="mb-12">
            <h2 className="mb-6 flex items-center gap-2 text-2xl font-bold text-brand-purple">
              <Building2 className="size-6 text-brand-teal" />
              Program Goals
            </h2>
            <div className="rounded-lg border bg-brand-purple/5 p-6">
              <p className="text-muted-foreground">
                <strong>
                  97% of cyber-attacks target leaders and employees.
                </strong>{" "}
                Empower government leaders and business executives with the
                right knowledge to protect organizations from cyber risks and
                create a cyber-resilient business model.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-purple/5 p-6">
              <p className="text-muted-foreground">
                ...
                virtual environment. This is a <strong>15-hour</strong>{" "}
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">Empower Your Leadership</h3>
            <p className="mb-6 text-muted-foreground">
              Learn to make informed decisions on how to react to emerging tech
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-teal/5 p-6">
              <p className="text-muted-foreground">
                ...
                . Technical skills and relevant tools are learned through
                practical hands-on and simulation exercises in a safe and secure
                virtual environment. This is a <strong>15-hours</strong>{" "}
                self-paced workshop delivered on a blended in-class and on-line
                platforms.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-brand-teal/5 p-8 text-center">
            <h3 className="mb-4 text-2xl font-bold">Lead with Cybersecurity</h3>
            <p className="mb-6 text-muted-foreground">
              Understand cybersecurity risks and strategy to protect your
              organization.
            </p>
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Button
