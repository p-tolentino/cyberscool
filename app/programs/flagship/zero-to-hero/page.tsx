...
import { CheckCircle2, Clock, User, Briefcase, ShieldCheck } from "lucide-react"
import { programs } from "@/lib/data/programs"

export async function generateMetadata() {
  const program = programs.find((p) => p.slug === "zero-to-hero")
  return {
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-3">
              <ShieldCheck className="size-8 text-brand-purple" />
              {program.badge && (
          ...
          <div className="mb-12 grid gap-4 md:grid-cols-3">
            ...
            <Card className="border-brand-purple/20">
              <CardContent className="pt-6">
                ...
                <CardTitle className="text-xl text-brand-purple">
                  {program.isFlagship ? "Flagship" : "Specialized"}
                </CardTitle>
          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg border bg-brand-teal/5 p-6">
              <p className="text-muted-foreground">
                ...
                virtual environment. This is a <strong>480-hours</strong> or
                12-consecutive weeks training course delivered on a blended
                in-class and on-line platforms.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-gradient-to-r from-brand-purple/10 to-brand-teal/10 p-8 text-center">
            ...
            <p className="mb-6 text-muted-foreground">
              No IT background required. Join 500+ graduates who transformed
              their careers.
            </p>
